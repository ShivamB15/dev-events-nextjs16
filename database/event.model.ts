...
// Pre-save hook for slug generation and data normalization (async, no next())
...
function normalizeTime(timeString: string): string {
    ...
    if (period) {
        // Validate 12-hour format: hours must be 1-12
        if (hours < 1 || hours > 12) {
            throw new Error('Invalid time format. 12-hour format requires hours 1-12');
        }
